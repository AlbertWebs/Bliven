    ...
    <ul id="iq-sidebar-toggle" class="iq-menu">
       ...
       <li aria-expanded="true">
          ...
          <ul id="menu-design" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
             <li><a href="horizontal-menu#"><i class="fa fa-pencil"></i>Record Sale</a></li>
             <li><a href="horizontal-top-menu#"><i class="fa fa-money"></i>Sales</a></li>
          </ul>
       </li>
       <li aria-expanded="true">
        ...
        <ul id="menu-designs" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
           <li><a href="horizontal-menu#"><i class="ri-git-commit-line"></i>Horizontal menu</a></li>
           <li><a href="horizontal-top-menu#"><i class="ri-text-spacing"></i>Horizontal Top Menu</a></li>
           <li><a href="two-sidebar#"><i class="ri-indent-decrease"></i>Two Sidebar</a></li>
           <li><a href="vertical-top-menu#"><i class="ri-line-height"></i>Vertical block menu</a></li>
        </ul>
     </li>
     <li aria-expanded="true">
       ...
       <li>
          ...
          <ul id="ui-elements" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
             <li><a href="ui-colors#"><i class="las la-palette"></i>My Score Card</a></li>
             <li><a href="ui-typography#"><i class="las la-keyboard"></i>Financial Ratios</a></li>
             <li><a href="ui-alerts#"><i class="las la-tag"></i>Liquidity</a></li>
             <li><a href="ui-badges#"><i class="lab la-atlassian"></i>Profitabity</a></li>
             <li><a href="ui-badges#"><i class="lab la-atlassian"></i>Leverage</a></li>
             <li><a href="ui-badges#"><i class="lab la-atlassian"></i>Efficiency</a></li>
          </ul>
       </li>
       <li>
