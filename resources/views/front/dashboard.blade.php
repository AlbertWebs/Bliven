                ...
                <div class="iq-card-body">
                   <div class="d-flex align-items-center mt-3">
                      ...
                      <div class="iq-details col-sm-9 p-0">
                         <div class="d-flex align-items-center justify-content-between">
                            <span class="title text-dark">Monthly expenses</span>
                            <div class="percentage"><b><span>$</span> 6200 </b></div>
                         </div>
                   ...
                   <div class="d-flex align-items-center">
                      ...
                      <div class="iq-details col-sm-9 p-0">
                         <div class="d-flex align-items-center justify-content-between">
                            <span class="title text-dark">Bills</span>
                   ...
                   <div class="d-flex align-items-center">
                      ...
                      <div class="iq-details col-sm-9 p-0">
                         <div class="d-flex align-items-center justify-content-between">
                            <span class="title text-dark">Income</span>
                   ...
                   <div class="d-flex align-items-center">
                      ...
                      <div class="iq-details col-sm-9 p-0">
                         <div class="d-flex align-items-center justify-content-between">
                            <span class="title text-dark">Daily Purchases</span>
                   ...
                   <div class="d-flex align-items-center">
                      ...
                      <div class="iq-details col-sm-9 p-0">
                         <div class="d-flex align-items-center justify-content-between">
                            <span class="title text-dark">Profits</span>
                ...
                <div class="iq-card-body">
                   <ul class="perfomer-lists m-0 p-0">
                      <li class="d-flex mb-4 align-items-center">
                         <div class="user-img img-fluid"><img src="{{asset('dashboards/images/page-img/linkedin.png')}}" alt="story-img" class="rounded avatar-40"></div>
                         <div class="media-support-info ml-3">
                            <h6>LinkedIn</h6>
                            <p class="mb-0 font-size-12">Proffessional Leads</p>
                         </div>
                         <div class="iq-card-header-toolbar d-flex align-items-center">
                      ...
                      <li class="d-flex mb-4 align-items-center">
                         <div class="user-img img-fluid"><img src="{{asset('dashboards/images/page-img/30.png')}}" alt="story-img" class="rounded avatar-40"></div>
                         <div class="media-support-info ml-3">
                            <h6>Behance</h6>
                            <p class="mb-0 font-size-12">Developer</p>
                         </div>
                         <div class="iq-card-header-toolbar d-flex align-items-center">
                            <span class="text-primary"><b>$250.50</b></span>
                         </div>
                      </li>
                      <li class="d-flex mb-4 align-items-center">
                         <div class="user-img img-fluid"><img src="{{asset('dashboards/images/page-img/31.png')}}" alt="story-img" class="rounded avatar-40"></div>
                         <div class="media-support-info ml-3">
                            <h6>Instagram</h6>
                            <p class="mb-0 font-size-12">Instagram Leads</p>
                         </div>
                         <div class="iq-card-header-toolbar d-flex align-items-center">
                            <span class="text-primary"><b>$158.00</b></span>
                         </div>
                      </li>
                      <li class="d-flex mb-4 align-items-center">
                         <div class="user-img img-fluid"><img src="{{asset('dashboards/images/page-img/32.png')}}" alt="story-img" class="rounded avatar-40"></div>
                         <div class="media-support-info ml-3">
                            <h6>Twitter Sales</h6>
                            <p class="mb-0 font-size-12">Twitter API</p>
                         </div>
                         <div class="iq-card-header-toolbar d-flex align-items-center">
                            <span class="text-primary"><b>$500.00</b></span>
                         </div>
                      </li>
                      <li class="d-flex mb-4 align-items-center">
                         <div class="user-img img-fluid"><img src="{{asset('dashboards/images/page-img/Facebook-logo.png')}}" alt="story-img" class="rounded avatar-40"></div>
                         <div class="media-support-info ml-3">
                            <h6>Facebook Sales</h6>
                            <p class="mb-0 font-size-12">Facebook API</p>
                         </div>
                         <div class="iq-card-header-toolbar d-flex align-items-center">
                            <span class="text-primary"><b>$3490.00</b></span>
                         </div>
                      </li>
                   </ul>
                </div>
